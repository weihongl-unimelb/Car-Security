			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				if (username.equals(DemoApplication.getInstance().getUserName()))
					...
					if (model.getSettingMsgNotification()) {
						startActivity(new Intent(getActivity(), VideoCallActivity.class).putExtra("userId", username).putExtra("isComingCall", false));
					} else {
						startActivity(new Intent(getActivity(),MonitorActivity.class).putExtra("userId", username).putExtra("isComingCall", false));
					} 
				}
			}
		});
