			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				if (Constant.NEW_FRIENDS_USERNAME.equals(username)) {
					...
					if (model.getSettingMsgNotification()) {
						startActivity(new Intent(getActivity(), VideoCallActivity.class).putExtra("userId", adapter.getItem(position).getUsername()).putExtra("isComingCall", false));
					} else {
						startActivity(new Intent(getActivity(),MonitorActivity.class).putExtra("userId", adapter.getItem(position).getUsername()).putExtra("isComingCall", false));
					}
